...
func main() {
 ...
 // aqui va la prube apara respuesta index
 app.Get("/Respuestas", RespuestaControler.IndexGet)
 app.Post("/Respuestas", RespuestaControler.IndexPost)

 //Alta
 app.Get("/Respuestas/alta", RespuestaControler.AltaGet)
 app.Post("/Respuestas/alta", RespuestaControler.AltaPost)

 //Edicion
 app.Get("/Respuestas/edita", RespuestaControler.EditaGet)
 app.Post("/Respuestas/edita", RespuestaControler.EditaPost)
 app.Get("/Respuestas/edita/:ID", RespuestaControler.EditaGet)
 app.Post("/Respuestas/edita/:ID", RespuestaControler.EditaPost)

 //Detalle
 app.Get("/Respuestas/detalle", RespuestaControler.DetalleGet)
 app.Post("/Respuestas/detalle", RespuestaControler.DetallePost)
 app.Get("/Respuestas/detalle/:ID", RespuestaControler.DetalleGet)
 app.Post("/Respuestas/detalle/:ID", RespuestaControler.DetallePost)
