...
import (
	...
	//NO TIENE "../../Modulos/Session" Y "../../Modelos/Surtidor" DIEGO
)
...
func IndexGet(ctx *iris.Context) {
	fmt.Println("=================================")
	fmt.Println("=================================")
	fmt.Println("Respuesta.RespuestaControler.go.IndexGet: GET")
	fmt.Println("=================================")
	fmt.Println("=================================")
	...
	var Send ExpresionesRegulares.SExpresion // Send = una estructura DIEGO
	var Cabecera, Cuerpo string
	numeroRegistros, _ := (ExpresionesRegulares.CountAll()) // regresa un int y error DIEGO
	paginasTotales = MoGeneral.Totalpaginas(numeroRegistros, limitePorPagina)// regresa un entero
	...
	Send.SEstado = true
	ctx.Render("Respuesta/RespuestaIndex.html", Send)
...
func IndexPost(ctx *iris.Context) {
	fmt.Println("=================================")
	fmt.Println("=================================")
	fmt.Println("Respuesta.RespuestaControler.go.IndexPost: GET")
	fmt.Println("=================================")
	fmt.Println("=================================")
	if !sessionUtils.IsStarted(ctx) {
		ctx.Redirect("/Login", 301)
...
func AltaGet(ctx *iris.Context) {
	...
	ctx.Render("Respuesta/RespuestaAlta.html", Send)
...
func AltaPost(ctx *iris.Context) {
	...
	ctx.Render("Respuesta/RespuestaDetalle.html", Send)
...
func EditaGet(ctx *iris.Context) {
	...
	if id != "" {
		...
		fmt.Println("aqui va el valo de getone",e)
		if err != nil {
	...
	ctx.Render("Respuesta/RespuestaEdita.html", Send)
